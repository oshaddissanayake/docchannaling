  ...
  Widget _indicator(bool isActive){
    return AnimatedContainer(duration: Duration(milliseconds: 150),
      ...
      decoration: BoxDecoration(
        color:  isActive ? Colors.white : Color(0xFF0F94FF),
        ...
        child: Container(
          decoration: BoxDecoration(
             gradient :LinearGradient(
                colors: [Color(0xff03a1e9), Color(0xffffffff)],
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Column(crossAxisAlignment:CrossAxisAlignment.start,
                        children: <Widget>[
                          Center(child:Lottie.network('https://assets6.lottiefiles.com/packages/lf20_zpjfsp1e.json',
                            height: 350.0,
                          ),
                          ),
                          SizedBox(height:30.0),
                          Text('Text about channeling',
                              style: GoogleFonts.openSans(textStyle:TextStyle(fontSize:20, color: Colors.black,fontWeight:FontWeight.bold ),)
                          ),
                          SizedBox(height:15.0),
                          Text('Support lip oral cancer paitent',
